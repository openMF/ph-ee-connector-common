...
public class JsonWebSignatureService implements JsonWebSignature {
    ...
    /**
     * Takes data,signature and tenantName. And verifies if signature is valid or not. TenantName is used to fetch
     * respective keys
     *
     * @param data
     *            data for which signature to be verified as a string
     * @param signature
     ...
     *             thrown while parsing public key
     ...
     *             thrown while parsing public key
     */
    public boolean verifyForTenant(String data, String signature, String tenantName)
    ...
    /**
     * Takes data and create the corresponding signature. TenantName is used to fetch respective keys
     *
     * @param data
     *            the data which is to be signed
     * @param tenantName
     *            name of the tenant
     ...
     *             thrown while parsing public key
     */
    public String signForTenant(String data, String tenantName) throws NoSuchPaddingException, IllegalBlockSizeException,
    ...
    @Override
    public boolean verify(String data, String signature, String publicKey) throws NoSuchPaddingException, IllegalBlockSizeException,
            NoSuchAlgorithmException, BadPaddingException, InvalidKeySpecException, InvalidKeyException {
    ...
    @Override
    public String create(String data, String privateKey) throws NoSuchPaddingException, IllegalBlockSizeException, NoSuchAlgorithmException,
