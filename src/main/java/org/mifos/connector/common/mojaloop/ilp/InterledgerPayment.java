...
public interface InterledgerPayment {
    ...
    class Builder {
        ...
        private static final class Impl implements InterledgerPayment {
            ...
            // return this.destinationAccount.equals(impl.destinationAccount) &&
            // this.destinationAmount.equals(impl.destinationAmount) && Arrays.equals(this.data, impl.data);
            // } else {
            // return false;
            // }
            // }
            ...
            // return "InterledgerPayment.Impl{destinationAccount=" + this.destinationAccount + ", destinationAmount=" +
            // this.destinationAmount + ", data=" + Arrays.toString(this.data) + '}';
            // }
        }
    }
}
